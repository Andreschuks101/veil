...
2. Use GitHub's [private vulnerability reporting](https://github.com/Miracle656/veil/security/advisories/new)
...
Community review is welcome — see the [GitHub repository](https://github.com/Miracle656/veil) to review the source.
